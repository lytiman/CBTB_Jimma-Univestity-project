                        ...
                        <div class="col-lg-12">
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    ...
                                    <h3>በኢትዮጵያ ፌደራላዊ ዴሞክራሲያዊ ሪፐብሊክ የውሳኝ ኩነት ምዝገባ</h3>
                                        <h3>Federal Democratic Republic of Ethiopia Vital Registration</h3>
                                        <h4>የልደት ምስክር ወረቀት</h4>
...
<strong> Application Number:</strong>   <?php  echo $row->ApplicationID;?></td></tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <th scope>Rigion</th>
    <td><?php  echo $row->Rigion;?></td>
    
  </tr>
  <tr>
     <th scope>Name of Mother</th>
    <td><?php  echo $row->NameOfMother;?></td>
    <th scope>Nationality of Mother</th>
    <td><?php  echo $row->MotherNationality;?></td>
  </tr>
  <tr>
     <th scope>Name of Father</th>
    <td><?php  echo $row->NameofFather;?></td>
    <th scope>Nationality of Father</th>
    <td><?php  echo $row->NationalityFather;?></td>
  </tr>
  <th scope>Zone/City</th>
