...
if(isset($_POST['submit']))
  {
    $email=$_POST['email'];
$mobile=$_POST['mobile'];
$newpassword=md5($_POST['newpassword']);// this to change the password to hash_code 
...
<body class="materialdesign">
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="password" name="newpassword" placeholder="please include chars,symbols and numbers" required="true" pattern="(?=.*\d)(?=.*[a-zA-Z])(?=.*\W).{6,}"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input class="form-control" type="password" name="confirmpassword" placeholder="Confirm Password" required="true" pattern="(?=.*\d)(?=.*[a-zA-Z])(?=.*\W).{6,}"/>
                                                <i class="fa fa-lock login-user" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
    document.querySelector('wrapper-pro').addEventListener('submit', function(event) {
        var password = document.querySelector('input[name="password"]').value;
        var hasLetter = /[a-zA-Z]/.test(password);
        var hasNumber = /\d/.test(password);
        var hasCharacter = /\W/.test(password);
